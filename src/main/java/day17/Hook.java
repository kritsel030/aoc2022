...
/**
 * For shape Hook, the position P is determined by its bottom left element:
 *
 *       @
 *       @
 *   P @ @
...
public class Hook extends Shape {
    ...
    public boolean tryBlow(boolean right, char[][] grid) {
        if (right) {
            int[] rightCheck1 = {position[0] + 3, position[1] + 2};
            int[] rightCheck2 = {position[0] + 3, position[1] + 1};
            int[] rightCheck3 = {position[0] + 3, position[1]};
            ...
            int[] leftCheck1 = {position[0] + 1, position[1] + 2};
            int[] leftCheck2 = {position[0] + 1, position[1] + 1};
            int[] leftCheck3 = {position[0] - 1, position[1]};
    ...
    public boolean tryDrop(char[][] grid) {
        ...
        if (!goOn) {
            // top
            grid[position[0] + 2][position[1] + 2] = '#';
            // below the top
